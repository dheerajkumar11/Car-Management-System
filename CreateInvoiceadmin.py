...
dob_entry = DateEntry(Customer_details_frame, selectmode = "day" , date_pattern='yyyy-mm-dd', bg = "black", fg = "black", width=17)
...
buttons_frame = tkinter.LabelFrame(frame, text="" , font=("Arial", 15), bg="#E4E4E4" , padx=20, pady=20)
...
btnMainPage = tkinter.Button(buttons_frame, width=10, text="Main Page" , font=("Comic Sans MS", 15 , 'bold'), bg="lavender", command=AdminLoginpage)
